 ...
 */
class Save extends \Overdose\Testimonials\Controller\Adminhtml\Testimonials
{
    /**
        ...
        if ($data) {
            ...
            if (isset($data['identifier']) && !isset($data['id'])) {
                ...
                $existBundlepotimages = $this->_objectManager
                    ->create(\Overdose\Testimonials\Model\Bundlepotimage::class)
                    ->getCollection()
            ...
            $model = $this->_objectManager->create(\Overdose\Testimonials\Model\Bundlepotimage::class)->load($id);
            if (!$model->getId() && $id) {
