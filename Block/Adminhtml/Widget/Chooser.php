...
namespace Overdose\Testimonials\Block\Adminhtml\Widget;
...
class Chooser extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        return $this->_objectManager->create(\Overdose\Testimonials\Model\Bundlepotimage::class);
    }
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                'header' => __('Preview'),
                'index' => 'filename',
                'renderer' => \Overdose\Testimonials\Block\Adminhtml\Grid\Renderer\Preview::class,
                'filter'   => false,
                'sortable' => false
            ]
        );
